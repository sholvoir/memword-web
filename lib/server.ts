...
export const signup = (phone: string, name: string) => getRes(`${API_URL}/pub/signup`, { phone, name });
export const signin = (name: string, code: string) => getRes(`${API_URL}/pub/signin`, { name, code });
...
export const deleteDict = (word: string) =>
    getRes(`${API_URL}/admin/dict`, { q: word }, { method: 'DELETE', headers: authHead });
...
export const getBooks = () =>
    getJson<Array<IBook>>(`${API_URL}/pub/book`)

export const getBook = (bid: string) =>
    fetch(`${API_URL}/pub/book/${bid}`);

export const postBook = (name: string, words: string, disc?: string) =>
    getRes(`${API_URL}/api/book`, { name, disc }, { body: words, method: 'POST', headers: authHead });

export const putBook = (name: string, words: string, disc?: string) =>
    getRes(`${API_URL}/api/book`, { name, disc }, { body: words, method: 'PUT', headers: authHead });

export const deleteBook = (name: string) =>
    getRes(`${API_URL}/api/wordlist`, { name }, { method: 'DELETE', headers: authHead });

export const postVocabulary = (words: string) => 
    fetch(`${API_URL}/admin/vocabulary`, { body: words, method: 'POST', headers: authHead });
...
export const getIssues = () =>
    getJson<Array<IIssue>>(`${API_URL}/admin/issue`, undefined, { method: 'GET', headers: authHead });

export const deleteIssue = (_id: string) =>
    getJson(`${API_URL}/admin/issue`, { id: _id }, { method: 'DELETE', headers: authHead });